...
class Filter(models.Model):
    ...
    srcset = models.ForeignKey(Ipset, null=True, blank=True, related_name='filter_src_set', on_delete=models.PROTECT)
    ...
    dstset = models.ForeignKey(Ipset, null=True, blank=True, related_name='filter_dst_set', on_delete=models.PROTECT)
