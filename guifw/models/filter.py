...
class Filter(models.Model):
    ...
    srcset = models.ForeignKey(Ipset, null=True, blank=True, related_name='src_set', on_delete=models.PROTECT)
    ...
    dstset = models.ForeignKey(Ipset, null=True, blank=True, related_name='dst_set', on_delete=models.PROTECT)
    ...
    in_interface = models.ForeignKey(Interface, null=True, blank=True, related_name='in_in', on_delete=models.PROTECT)
    out_interface = models.ForeignKey(Interface, null=True, blank=True, related_name='in_out', on_delete=models.PROTECT)
