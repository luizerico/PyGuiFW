...
class Filter(models.Model):
    ...
    in_interface = models.ForeignKey(Interface, null=True, blank=True, related_name='filter_in_in', on_delete=models.PROTECT)
    out_interface = models.ForeignKey(Interface, null=True, blank=True, related_name='filter_in_out', on_delete=models.PROTECT)
