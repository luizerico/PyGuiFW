...
class Filter(models.Model):
    ...
    source = models.ManyToManyField(Address, blank=True, related_name='filter_source')
    srcset = models.ForeignKey(Ipset, null=True, blank=True, related_name='filter_srcset', on_delete=models.PROTECT)
    srcport = models.ManyToManyField(Port, blank=True, related_name='filter_srcport')
    destiny = models.ManyToManyField(Address, blank=True, related_name='filter_destiny')
    dstset = models.ForeignKey(Ipset, null=True, blank=True, related_name='filter_dstset', on_delete=models.PROTECT)
    dstport = models.ManyToManyField(Port, blank=True, related_name='filter_dstport')
    protocol = models.ForeignKey(Protocol, null=True, blank=True, related_name="filter_protocol", on_delete=models.PROTECT)
    in_interface = models.ForeignKey(Interface, null=True, blank=True, related_name='filter_inin', on_delete=models.PROTECT)
    out_interface = models.ForeignKey(Interface, null=True, blank=True, related_name='filter_inout', on_delete=models.PROTECT)
