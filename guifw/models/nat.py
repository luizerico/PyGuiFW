...
class Nat(models.Model):
    ...
    to_ip = models.ForeignKey(Address, blank=True, null=True, related_name='nat_to_ip')
    to_port = models.ForeignKey(Port, blank=True, null=True, related_name='nat_to_port')
